...
{
	int         ret       = MSP_SUCCESS;
	const char *lgi_param = "appid = 5aaa223d,engine_start = ivw,ivw_res_path =fo|res/ivw/wakeupresource.jet, work_dir = ."; //使用唤醒需要在此设置engine_start = ivw,ivw_res_path =fo|xxx/xx 启动唤醒引擎
